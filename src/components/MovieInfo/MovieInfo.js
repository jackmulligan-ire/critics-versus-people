  ...
  render() {
    return (
      <Container className="w-100 d-flex flex-column align-items-center">
        <Row
          id="search-row-results"
          className="w-75 d-flex d-md-none justify-content-center my-3"
        >
        ...
        <Row className="w-75 mb-3 mb-md-0" id="ratings-row">
          <MovieRating
            reviewer="Critics"
            rating={this.props.movieData.Metascore}
          />
          <MovieRating
            reviewer="The People"
            rating={this.props.movieData.imdbRating}
          />
        </Row>
        <MovieSummary
