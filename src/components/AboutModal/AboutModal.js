  ...
  render() {
    return (
      <Modal show={this.props.show}>
        ...
        <Modal.Body>
          <p>
            The following data from the Open Movie Database are used to generate
            the ratings:
          </p>
          <ul>
            <li>
              Critics: Average score from{" "}
              <a
          ...
          <p>
            Additional data taken from IMDb and Amazon (posters) via OMDb (
            <a
